'''
Boolean Evaluation:
   Return the number of ways that an expression can be parenthesized and achieve a given truth value
   False (0), True(1) , AND (&), OR (|), XOR(^)
   Ex: count_eval("1^0|0|1", false) -> 2
